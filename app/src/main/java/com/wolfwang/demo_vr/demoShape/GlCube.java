package com.wolfwang.demo_vr.demoShape;
...
//			cubeNormalBfr[i] = FloatBuffer.wrap(cubeNormalCoords[i]);
			cubeNormalBfr[i] = Utils.bufferUtil(cubeNormalCoords[i]);
			cubeTextureBfr[i] = Utils.bufferUtil(cubeTextureCoords[i]);
		}
	}
...
//			cubeVertexBfr[i] = FloatBuffer.wrap(vertices);
			cubeVertexBfr[i] = Utils.bufferUtil(vertices);
		}
	}
