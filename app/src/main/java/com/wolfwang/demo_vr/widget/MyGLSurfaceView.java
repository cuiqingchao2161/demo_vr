package com.wolfwang.demo_vr.widget;
 ...
 * Created by qingchao.cui on 2019/7/12.
 */
...
//            gl.glEnable(GL10.GL_DEPTH_TEST);
            ...
            textureId=initTexture(gl, R.drawable.wall);//纹理ID
    ...
    public int initTexture(GL10 gl,int drawableId)//textureId
    {
        ...
        gl.glBindTexture(GLES20.GL_TEXTURE_2D, currTextureId);
        gl.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER,GLES20.GL_LINEAR_MIPMAP_NEAREST);
        gl.glTexParameterf(GLES20.GL_TEXTURE_2D,GLES20.GL_TEXTURE_MAG_FILTER,GLES20.GL_LINEAR_MIPMAP_LINEAR);
        ((GL11)gl).glTexParameterf(GLES20.GL_TEXTURE_2D, GL11.GL_GENERATE_MIPMAP, GLES20.GL_TRUE);
        gl.glTexParameterf(GL10.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S,GL10.GL_REPEAT);
        gl.glTexParameterf(GL10.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T,GL10.GL_REPEAT);
