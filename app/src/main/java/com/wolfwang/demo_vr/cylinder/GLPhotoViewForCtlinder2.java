 ...
 */
public class GLPhotoViewForCtlinder2 extends GLSurfaceView {
     ...
     */
    public GLPhotoViewForCtlinder2(Context context) {
        this(context, null);
     ...
     */
    public GLPhotoViewForCtlinder2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
