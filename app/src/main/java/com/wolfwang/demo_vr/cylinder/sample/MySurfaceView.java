...
class MySurfaceView extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            Log.e("onSurfaceChanged","ratio="+ratio);
            Log.e("onSurfaceChanged","width="+width);
            Log.e("onSurfaceChanged","height="+height);
            //调用此方法计算产生透视投影矩阵
            MatrixState.setProjectFrustum(-1, 1, -ratio, ratio, 6f, 100);
            //控制相机位置 1无畸变  其他播放图像边缘有畸变
            float currentDegree= (float) (Math.toDegrees(Math.atan(1)) * 4.5);//
//            MatrixState.perspectiveM(currentDegree, ratio, -ratio, 1, 2f, 500f);
            //调用此方法产生摄像机9参数位置矩阵
            MatrixState.setCamera(0f,0f,1,0f,0f,0f,0f,1.0f,0.0f);
...
//            }.start();
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载纹理
            textureId=initTexture(R.drawable.ddd);
            //创建圆柱对象
            cylinder = new Cylinder(MySurfaceView.this,1,20f,25f,36,textureId,textureId,textureId);
            //创建圆柱骨架对象
            cylinderl= new CylinderL(MySurfaceView.this,1,1.2f,2f,6);
