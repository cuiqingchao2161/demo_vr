...
import static com.wolfwang.demo_vr.cylinder.sample.ShaderUtil.createProgram;
...
public class Circle
{
    ...
    public void initShader(MySurfaceView mv){
        //加载顶点着色器的脚本内容
        mVertexShader= com.wolfwang.demo_vr.cylinder.sample.ShaderUtil.loadFromAssetsFile("vertex_tex_light.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader= com.wolfwang.demo_vr.cylinder.sample.ShaderUtil.loadFromAssetsFile("frag_tex_light.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
