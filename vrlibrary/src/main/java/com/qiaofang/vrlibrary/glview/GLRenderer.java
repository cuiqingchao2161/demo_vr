package com.qiaofang.vrlibrary.glview;
...
import com.qiaofang.vrlibrary.glview.model.UVSphere;
...
//            "                0.0, -0.213, 2.112,\n" +
//            "                1.793, -0.533,   0.0);\n" +
//            "        yuv.x = texture2D(sam2DY,vUV).r - (16.0/255.0);\n" +
//            "        yuv.yz = texture2D(sam2DUV,vUV).rg - vec2(0.5, 0.5);\n" +
//            "        rgb = convert*yuv;\n" +
...
//    private UVSphere uVSphere1 = null;
//    private UVSphere uVSphere2 = null;
//    private UVSphere uVSphere3 = null;
//    private UVSphere uVSphere4 = null;
...
//        uVSphere1 = new UVSphere(Constants.TEXTURE_SHELL_RADIUS, Constants.SHELL_DIVIDES, 0);
//        uVSphere2 = new UVSphere(Constants.TEXTURE_SHELL_RADIUS, Constants.SHELL_DIVIDES, 1);
//        uVSphere3 = new UVSphere(Constants.TEXTURE_SHELL_RADIUS, Constants.SHELL_DIVIDES, 2);
//        uVSphere4 = new UVSphere(Constants.TEXTURE_SHELL_RADIUS, Constants.SHELL_DIVIDES, 3);
    ...
    public void onDrawFrame(final GL10 gl) {
        ...
        mEastShell.draw(mPositionHandle, mUVHandle);//东半球纹理贴图

        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures[1]);
        GLES20.glUniform1i(mTexHandle, 0);
        mWestShell.draw(mPositionHandle, mUVHandle);//西半球纹理贴图

//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures[0]);
//        GLES20.glUniform1i(mTexHandle, 0);
//
//        uVSphere1.draw(mPositionHandle, mUVHandle);
//
//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures[1]);
//        GLES20.glUniform1i(mTexHandle, 0);
//
//        uVSphere2.draw(mPositionHandle, mUVHandle);
//
//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures[2]);
//        GLES20.glUniform1i(mTexHandle, 0);
//
//        uVSphere3.draw(mPositionHandle, mUVHandle);
//
//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures[3]);
//        GLES20.glUniform1i(mTexHandle, 0);
//
//        uVSphere4.draw(mPositionHandle, mUVHandle);
        return;
    }
